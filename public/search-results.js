...
class SearchResultsApp {
        ...
        this.clinicsData = [
            {
                id: 'dio',
                clinic_name: 'DIO',
                official_url: 'https://sss.ac01.l-ad.net/cl/p1a64143O61e70f7/?bid=a6640dkh37648h88&param3=[GCLID_PLACEHOLDER]',
                storeCount: 22,
    ...
    */
    ...
    getOfficialUrl(clinicId) {
        const urlMap = {
            'dio': 'https://sss.ac01.l-ad.net/cl/p1a64143O61e70f7/?bid=a6640dkh37648h88&param3=[GCLID_PLACEHOLDER]',
